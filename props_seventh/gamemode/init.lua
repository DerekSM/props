--[[
		...
		Most of this is copypasted from original scpropkill
]]--


--[[
create player accuracy

	player prop hits / prop spawns
		dont include player damage themselves
		onplayertakedamage or something
]]
...
PROPKILL.BattleCooldown = PROPKILL.BattleCooldown or 0
...
util.AddNetworkString( "props_UpdateTopProps" )
...
local pkfiles, pkfolders = file.Find( "gamemodes/" .. GM.FolderName .. "/gamemode/modules/*", "GAME" )
PrintTable( pkfiles )
