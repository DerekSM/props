...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox( 0, 0, 0, w, h, team.GetColor(self.Player:Team()) )
        ...
        -- We'll highlight based on who we hover over
	--[[if self.Player == LocalPlayer() then
		draw.RoundedBox( 0, 0, 0, w, h, Color( 51, 51, 51, 255 ) )
	end]]

		-- Basically we are drawing a divider line between players. Makes the scoreboard pop out
	draw.RoundedBox( 0, 0, h - 2, w, 2, Color( 51, 51, 51, 255 ) )

end

vgui.Register( "props_playerrow_alt", PANEL, "Panel" )
