...
function PANEL:Init()
	...
	local function TitlePanelClickSort( pnl )
		...
		if self:GetSortMode() == 1 then
			SortTitle:SetIcon( "icon16/tick.png")
		elseif self:GetSortMode() == 2 then
			SortDifficulty:SetIcon( "icon16/tick.png")
		elseif self:GetSortMode() == 3 then
			SortCompleted:SetIcon( "icon16/tick.png")
		end
...
function PANEL:CallUpdate()
	...
	if GetCombatAchievements != nil then
