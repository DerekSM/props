...
function PANEL:Init()
	...
	self.BattleTypePanel.Paint = function( pnl, w, h )
		...
		draw.RoundedBox( 0, 0, 0, w, h, Color( 159, 170, 173, 255 ) )
	end
	...
	self.BattleTypeText:SetTextColor( Color(76,82,87,255) ) --Color( 62, 62, 62, 255 ) )
	...
	self.LeftPanel.Paint = function( pnl, w, h )
		draw.RoundedBox( 0, 0, 0, w, h, Color( 172, 179, 185, 255 ) )
	end
	...
	self.LeftPanel.AvatarPanel.Paint = function( self, w, h )
		draw.RoundedBox( 0, 0, 0, w, h, Color( 137, 143, 148, 255 ) )
	end
	...
	self.LeftPanel.AdvOptions.pButton:SetTextColor( Color( 240, 240, 240, 255 ) )
	self.LeftPanel.AdvOptions.pButton:SetText( "Click..." )
	...
	self.LeftPanel.AdvOptions.pButton.Paint = function( pnl, w, h )
		draw.RoundedBox( 0, 0, 0, w, h, Color( 103, 109, 166, 255 ) )
	end
	...
	self.RightPanel.RecentHeaderPanel.Text:SetTextColor( Color( 76, 82, 87, 255 ) )
	...
	self.RightPanel.RecentLabelPanel.ColumnName:SetTextColor( Color( 103, 109, 116, 255 ) )
	...
	self.RightPanel.RecentLabelPanel.ColumnWinner:SetTextColor( Color( 103, 109, 116, 255 ) )
	surface.SetFont( "props_HUDTextSmall" )
	...
	self.RightPanel.RecentLabelPanel.ColumnScore:SetTextColor( Color( 103, 109, 116, 255 ) )
	surface.SetFont( "props_HUDTextSmall" )
	...
	for k,v in ipairs( PROPKILL.RecentBattles or {} ) do
		...
		self.RightPanel.RecentContentPanel[ "recent" .. k ].ContentNames:SetTextColor( Color( 73, 79, 136, 255 ) )
		surface.SetFont( "props_HUDTextSmall" )
		...
		self.RightPanel.RecentContentPanel[ "recent" .. k ].ContentWinner:SetTextColor( Color( 73, 79, 136, 255 ) )
		surface.SetFont( "props_HUDTextSmall" )
		...
		self.RightPanel.RecentContentPanel[ "recent" .. k ].ContentScore:SetTextColor( Color( 73, 79, 136, 255 ) )
	...
	self.RightPanel.StartButton:SetTextColor( Color( 240, 240, 240, 255 ) )
