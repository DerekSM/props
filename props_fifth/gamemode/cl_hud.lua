...
function props_ShowBattlingHUD()
	...
	VGUI_BattleBack:SetSize( math.ceil( ScrW() * GetUniversalSize( 680, 1440 ) ), 90 )
	...
	VGUI_InviterName.Sizew, VGUI_InviterName.Sizeh = surface.GetTextSize( PROPKILL.Battlers[ "inviter" ]:Nick() )
	...
	VGUI_InviterScore:SetPos( VGUI_InviterPanel:GetWide() / 2 - VGUI_InviterScore.Sizew / 2, VGUI_InviterPanel:GetTall() - VGUI_InviterScore:GetTall() - 10 )
	...
	VGUI_InviteeScore:SetPos( VGUI_InviteePanel:GetWide() / 2 - VGUI_InviteeScore.Sizew / 2, VGUI_InviteePanel:GetTall() - VGUI_InviteeScore:GetTall() - 10 )
	...
	VGUI_CountdownText:SetPos( VGUI_CountdownPanel:GetWide() / 2 - VGUI_CountdownText.Sizew / 2 + 5, 5 )
	...
	VGUI_CountdownTimer:SetPos( VGUI_CountdownPanel:GetWide() / 2- VGUI_CountdownTimer.Sizew / 2 + 5, VGUI_CountdownTimer.Sizeh + 10 )
