...
function props_ShowBattlingHUD()
	...
	VGUI_InviterName.Sizew, VGUI_InviterName.Sizeh = surface.GetTextSize( PROPKILL.Battlers[ "inviter" ] and PROPKILL.Battlers[ "inviter" ]:Nick() or "N/A 1" )
	...
	VGUI_InviterName:SetText( PROPKILL.Battlers[ "inviter" ] and PROPKILL.Battlers[ "inviter" ]:Nick() or "N/A" )
	...
	local zeroks = "00"
	if PROPKILL.Battlers[ "inviter" ] then
	...
	VGUI_InviterScore:SetPos( VGUI_InviterPanel:GetWide() / 2 - VGUI_InviterScore.Sizew / 2, VGUI_InviterPanel:GetTall() - (VGUI_InviterScore.Sizeh + 1) + 3 )
	...
	VGUI_InviteeName.Sizew, VGUI_InviteeName.Sizeh = surface.GetTextSize( PROPKILL.Battlers[ "invitee" ] and PROPKILL.Battlers[ "invitee" ]:Nick() or "N/A" )
	...
	VGUI_InviteeName:SetText( PROPKILL.Battlers[ "invitee" ] and PROPKILL.Battlers[ "invitee" ]:Nick() or "N/A" )
	...
	local zeroks = "00"
	if PROPKILL.Battlers[ "invitee" ] then
	...
	VGUI_InviteeScore:SetPos( VGUI_InviteePanel:GetWide() / 2 - VGUI_InviteeScore.Sizew / 2, VGUI_InviteePanel:GetTall() - (VGUI_InviteeScore.Sizeh + 1) + 3 )
