...
net.Receive( "props_BattleInit", function()
	...
	if not timer.Exists( "props_Battlecountdown" ) then
		PROPKILL.BattleTime = battletime > 0 and battletime or (PROPKILL.Config[ "battle_time" ].default * 60)
		--print( "doesnt exist timer countdown" )
	end
	timer.Simple( 0.8, function()
		timer.Create( "props_Battlecountdown", 1, battletime or PROPKILL.BattleTime, function()
