...
function PANEL:Init()
	...
	local canAccessConfig = hook.Call( "PlayerCanChangeSetting", nil, LocalPlayer(), nil )
	...
	local propSheetFight2 = propSheets:AddSheet( "Battle ( New )", battleNewPanel, "icon16/bomb.png", false, false, "Fight a player 1-on-1" )
