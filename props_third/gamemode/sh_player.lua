...
function _R.Player:AddKillstreak( i_Amt )
	--self.Killstreak = ( self.Killstreak or 0 ) + i_Amt
	self:SetNetVar( "Killstreak", self:GetNetVar( "Killstreak", 0 ) + i_Amt )
	
	--if self:GetKillstreak() + i_Amt > ( self.BestKillstreak or 0 ) then
	--	self.BestKillstreak = self:GetBestKillstreak() + 1
	...
	--self:UpdateKillstreak()
end
function _R.Player:SetKillstreak( i_Amt )
	--self.Killstreak = i_Amt
	self:SetNetVar( "Killstreak", i_Amt )
	
	--if i_Amt > ( self.BestKillstreak or 0 ) then
	--	self.BestKillstreak = i_Amt
...
function _R.Player:GetBestKillstreak()
	--return self.BestKillstreak or self:GetKillstreak()
